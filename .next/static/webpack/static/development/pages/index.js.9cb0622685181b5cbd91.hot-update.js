...
var Index = function Index(props) {
  return __jsx("div", {
    ...
    __self: this
  }, "Hellodd Next.js"), props.map(function (thing, index) {
    return __jsx("div", {
      key: index,
      __source: {
        fileName: _jsxFileName,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.awrap(prismic_javascript__WEBPACK_IMPORTED_MODULE_10___default.a.getApi(apiEndpoint));

        case 3:
          api = _context.sent;
          _context.next = 6;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_6___default.a.awrap(api.query(""));

        case 6:
          data = _context.sent;
          // An empty query will return all the documents
          console.log(data);
          return _context.abrupt("return", _objectSpread({}, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_7___default()(data.results.data)));
...
//# sourceMappingURL=index.js.9cb0622685181b5cbd91.hot-update.js.map