...
const Index = props => {
  return __jsx("div", {
    ...
    __self: undefined
  }, "Hellodd Next.js"), props.data.map((thing, index) => __jsx("div", {
    key: index,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
...
Index.getInitialProps = async () => {
  ...
  const api = await prismic_javascript__WEBPACK_IMPORTED_MODULE_1___default.a.getApi(apiEndpoint);
...
module.exports = __webpack_require__(/*! /Users/henrik/nexttest/pages/index.js */"./pages/index.js");
